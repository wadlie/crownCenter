...
FormData.SoilTexData = {}; // A list of errors associated with the questions

var ErrorLog = {};
ErrorLog.errors = [];
var RequiredQuestions = ['barcode', 'sand', 'silt', 'clay', 'textural_class'];
checkAllQuestionsAnswered().then(function () {
  return initializeFields();
}).then(function () {
  return formattingHandler();
}).then(function () {
  return __WEBPACK_IMPORTED_MODULE_1__lib_database__["b" /* findRecordWithBarcode */](FormData.SoilTexData.barcode, 'formsoil');
}).then(function (exists) {
  if (exists) {
    __WEBPACK_IMPORTED_MODULE_1__lib_database__["d" /* updateForm */](FormData.SoilTexData.barcode, 'FormSoil', FormData.SoilTexData).then(function () {
      return __WEBPACK_IMPORTED_MODULE_0__lib_app__["a" /* default */].result({
        success: true
      });
    })["catch"](function (error) {
      return __WEBPACK_IMPORTED_MODULE_1__lib_database__["a" /* errorHandling */](error, 'SoilTexData', ErrorLog).then(__WEBPACK_IMPORTED_MODULE_0__lib_app__["a" /* default */].result(ErrorLog));
    });
  } else {
    // Need to make a POST request to create a new record
    __WEBPACK_IMPORTED_MODULE_1__lib_database__["c" /* submitForm */](FormData.SoilTexData.farmcode, 'FormSoil', FormData.SoilTexData).then(function () {
      return __WEBPACK_IMPORTED_MODULE_0__lib_app__["a" /* default */].result({
        success: true
      });
    })["catch"](function (error) {
...
function initializeFields() {
  return new Promise(function (resolve, reject) {
    ...
    FormData.SoilTexData.farmcode = __WEBPACK_IMPORTED_MODULE_0__lib_app__["a" /* default */].getAnswer('barcode').substring(2, 5);
    FormData.SoilTexData.barcode = __WEBPACK_IMPORTED_MODULE_0__lib_app__["a" /* default */].getAnswer('barcode');
    FormData.SoilTexData.sand = __WEBPACK_IMPORTED_MODULE_0__lib_app__["a" /* default */].getAnswer('sand');
    FormData.SoilTexData.silt = __WEBPACK_IMPORTED_MODULE_0__lib_app__["a" /* default */].getAnswer('silt');
    FormData.SoilTexData.clay = __WEBPACK_IMPORTED_MODULE_0__lib_app__["a" /* default */].getAnswer('clay');
    /*
    ...
    */
    ...
    var tex_class = __WEBPACK_IMPORTED_MODULE_0__lib_app__["a" /* default */].getAnswer('textural_class');
    var modded_tex = "";
    ...
    switch (tex_class) {
      ...
      case 'silty_loam':
        modded_tex += "Silty loam";
        break;

      case 'clay_loam':
        modded_tex += "Clay loam";
        break;
    ...
    if (__WEBPACK_IMPORTED_MODULE_0__lib_app__["a" /* default */].isAnswered('notes')) {
      FormData.SoilTexData.notes = __WEBPACK_IMPORTED_MODULE_0__lib_app__["a" /* default */].getAnswer('notes');
    } else {
