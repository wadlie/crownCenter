...
var ErrorLog = {};
ErrorLog.errors = [];
var RequiredQuestions = ['barcode', 'tin_sub_dry_weight'];
checkAllQuestionsAnswered().then(function () {
  ...
  if (exists) {
    ...
    __WEBPACK_IMPORTED_MODULE_1__lib_database__["d" /* updateForm */](FormData.SoilData.barcode, 'FormSoil', FormData.SoilData).then(function () {
      ...
      return __WEBPACK_IMPORTED_MODULE_1__lib_database__["a" /* errorHandling */](error, 'soil dry', ErrorLog).then(__WEBPACK_IMPORTED_MODULE_0__lib_app__["a" /* default */].result(ErrorLog));
    });
  } else {
...
function formattingHandler() {
  return new Promise(function (resolve, reject) {
    var error; // Check barcode format
...
function initializeFields() {
  return new Promise(function (resolve, reject) {
    ...
    FormData.SoilData.tin_sub_dry_weight = __WEBPACK_IMPORTED_MODULE_0__lib_app__["a" /* default */].getAnswer('tin_sub_dry_weight');
