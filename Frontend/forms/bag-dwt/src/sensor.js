...
const RequiredQuestions = ['barcode', 'actual_recovery_date', 'total_dwt'];
  ...
  .then(function (exists) {
    if (exists) {
      ...
      database.updateForm(FormData.BagData.barcode, 'FormBag', FormData.BagData)
        ...
        .catch((error) => database.errorHandling(error, 'bag dwt', ErrorLog).then(app.result(ErrorLog)));
    } else {
...
function initializeFields() {
  return new Promise(function (resolve, reject) {
    ...
    FormData.BagData.actual_recovery_date = app.getAnswer('actual_recovery_date');
    FormData.BagData.total_dwt = app.getAnswer('total_dwt');
